...
from AlinaMusic import app as nexichat
...
CHATBOT_ON = [
    [
        InlineKeyboardButton(text="چالاککردن", callback_data="enable_chatbot"),
        InlineKeyboardButton(text="ناچالاککردن", callback_data="disable_chatbot"),
    ],
]
...
async def cb_handler(_, query: CallbackQuery):
    ...
    # If no status is set for this chat, enable the chatbot by default
...
──────────────
📡 ᴍᴀᴅᴇ ʙʏ ➪ [﮼محمد](https://t.me/IQ7amo) 💞**
"""
